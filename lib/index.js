...
var TodolistItem = (function (_React$Component) {
  ...
  _createClass(TodolistItem, [{
    ...
    value: function render() {
      ...
      var selection = { id: id, parentId: parentId };
      ...
      return _react2["default"].createElement(
        "li",
        { onMouseOut: handleHover.bind(this, selection, false),
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement("span", { className: "checkbox checkbox-is-" + isComplete,
            onClick: handleCheckboxClick.bind(this, selection) }),
          _react2["default"].createElement(
            "span",
            { className: this.name + "-title",
              onClick: handleTitleClick.bind(this, selection) },
            title
          )
        )
      );
